...
namespace Pulse.Controls
{
    ...
    {
        public BorderlessEntry _entry { get; private set; } = new BorderlessEntry();
        ...
        public static readonly BindableProperty DateTimeTextProperty =
  BindableProperty.Create("DateTimeText", typeof(string), typeof(DateTimePicker), null);
        public DateTimePicker()
        {
            ...
            _entry.FontSize = 11;
            _entry.FontFace = FontFace.PoppinsRegular;
